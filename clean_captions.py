...
res = dict()
for sub in captions:
   res[sub] = captions[sub][:1]

with open("Preprocessed Data/captions.pkl", "wb") as encoded_pickle:
...
print("Preprocessed Captions are successfully stored as **clean_captions.pkl** in the Preprocessed Data folder.")
